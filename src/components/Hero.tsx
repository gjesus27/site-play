...
const Hero = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 container mx-auto px-4 text-center max-w-4xl">
      <h1 className="font-heading text-4xl sm:text-5xl md:text-7xl font-bold uppercase leading-tight animate-fade-up">
        Transformamos atletas em{" "}
      ...
      <div className="mt-10 animate-fade-up" style={{ animationDelay: "0.3s" }}>
        <a
          ...
          className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-lg text-lg font-heading font-bold uppercase tracking-wider hover:brightness-110 transition-all hover:scale-105"
        >
